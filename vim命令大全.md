...
vim是我最喜欢的编辑器，也是linux下第二强大的编辑器。 虽然[emacs](https://so.csdn.net/so/search?q=emacs&spm=1001.2101.3001.7020)是公认的世界第一，我认为使用emacs并没有使用vi进行编辑来得高效。 如果是初学vi，运行一下vimtutor是个聪明的决定。 （如果你的系统环境不是中文，而你想使用中文的vimtutor，就运行vimtutor zh）
...
原文链接:https://blog.csdn.net/scaleqiao/article/details/45153379
